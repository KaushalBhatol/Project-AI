<?php
$page_name = 'History of Artificial Intelligence';
$metaDescription = '';
            ...
            <div class="col-lg-12 entries">
                ...
                <article class="entry entry-single">
                    ...
                    <div class="entry-content">
                        <br>
                        <h3>Maturation of Artificial Intelligence (1943-1952)</h3>
                        <ul>
                            <li>
                        ...
                        <h3>The birth of Artificial Intelligence (1952-1956)</h3>
                        <ul>
                            <li>Year 1955: An Allen Newell and Herbert A. Simon created the "first artificial intelligence program"Which was named as "Logic Theorist". This program had proved 38 of 52 Mathematics theorems, and find new and more elegant proofs for some theorems.</li>
